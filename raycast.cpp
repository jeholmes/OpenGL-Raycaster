...
int main( int argc, char **argv )
{
	...
	{
		if (strcmp(argv[i], "+s") == 0 || strcmp(argv[i], "-s") == 0) shadow_on = 1;
		if (strcmp(argv[i], "+l") == 0 || strcmp(argv[i], "-l") == 0) reflect_on = 1;
		if (strcmp(argv[i], "+c") == 0 || strcmp(argv[i], "-c") == 0) board_on = 1;
		if (strcmp(argv[i], "+r") == 0 || strcmp(argv[i], "-r") == 0) refract_on = 1;
		if (strcmp(argv[i], "+f") == 0 || strcmp(argv[i], "-f") == 0) diffuse_on = 1;
		if (strcmp(argv[i], "+p") == 0 || strcmp(argv[i], "-p") == 0) ss_on = 1;
	}
