...
Point plane_ctr = {0.0, -3.0, -9.0};
Vector plane_norm = {0.0, 1.0, 0.0};
float plane_scale = 8.5;
...
void set_up_default_scene() {
  ...
  float sphere1_transparency = 1.0;
  float sphere1_refraction = 2.0;
  Vector sphere1_norm = {0.0, 0.0, 0.0};
  float sphere1_scale = 0.0;
  scene = add_sphere(scene, sphere1_ctr, sphere1_rad, sphere1_ambient,
             sphere1_diffuse, sphere1_specular, sphere1_shineness,
		     sphere1_reflectance, sphere1_refraction, sphere1_transparency, 1, sphere1_norm, sphere1_scale);
  ...
  float sphere2_transparency = 0.6;
  float sphere2_refraction = 3.0;
  Vector sphere2_norm = {0.0, 0.0, 0.0};
  float sphere2_scale = 0.0;
  scene = add_sphere(scene, sphere2_ctr, sphere2_rad, sphere2_ambient,
             sphere2_diffuse, sphere2_specular, sphere2_shineness,
		     sphere2_reflectance, sphere2_refraction, sphere2_transparency, 2, sphere2_norm, sphere2_scale);
  ...
  float sphere3_refraction = 4.0;
  Vector sphere3_norm = {0.0, 0.0, 0.0};
  float sphere3_scale = 0.0;
  scene = add_sphere(scene, sphere3_ctr, sphere3_rad, sphere3_ambient,
             sphere3_diffuse, sphere3_specular, sphere3_shineness,
		     sphere3_reflectance, sphere3_refraction, sphere3_transparency, 3, sphere3_norm, sphere3_scale);

  // Plane
  Point sphere4_ctr = plane_ctr;
  float sphere4_rad = 0.0;
  float sphere4_ambient[] = {0.0, 0.0, 0.0};
  float sphere4_diffuse[] = {0.0, 0.0, 0.0};
  float sphere4_specular[] = {0.0, 0.0, 0.0};
  float sphere4_shineness = 0;
  float sphere4_reflectance = 0.5;
  float sphere4_transparency = 0.0;
  float sphere4_refraction = 0.0;
  Vector sphere4_norm = plane_norm;
  normalize(&sphere4_norm);
  float sphere4_scale = plane_scale;
  scene = add_sphere(scene, sphere4_ctr, sphere4_rad, sphere4_ambient,
             sphere4_diffuse, sphere4_specular, sphere4_shineness,
         sphere4_reflectance, sphere4_refraction, sphere4_transparency, 3, sphere4_norm, sphere4_scale);
}
...
void set_up_user_scene() {
  ...
  float sphere1_shineness = 10;
  float sphere1_reflectance = 0.4;
  float sphere1_transparency = 0.3;
  float sphere1_refraction = 3.0;
  Vector sphere1_norm = {0.0, 0.0, 0.0};
  float sphere1_scale = 0.0;
  scene = add_sphere(scene, sphere1_ctr, sphere1_rad, sphere1_ambient,
             sphere1_diffuse, sphere1_specular, sphere1_shineness,
  ...
  // sphere 2
  Point sphere2_ctr = {-1.2, -0.5, -2.5};
  float sphere2_rad = 1.1;
  float sphere2_ambient[] = {0.6, 0.6, 0.6};
  float sphere2_diffuse[] = {1.0, 0.0, 0.25};
  float sphere2_specular[] = {1.0, 1.0, 1.0};
  float sphere2_shineness = 6;
